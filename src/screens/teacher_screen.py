...
def teacher_tab_take_attendance():
    ...
    with c2:
        ...
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
            with st.spinner('Deep scanning classroom photo...'):
                all_detected_ids = {}
                ...
                if not enrolled_students:
                    st.warning('No students enrolled int this course')
                else:
...
def teacher_screen_login():
    ...
    st.header("Login your password", text_alignment='center')
    st.space()
    st.space()

    teacher_username = st.text_input("Enter username", placeholder='@runrsingh61')
...
def register_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
    ...
    if teacher_pass != teacher_pass_confirm:
        return False, "Passward doest't match"
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='Arun Singh')
